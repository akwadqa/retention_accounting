...
frappe.query_reports["Profitability Analysis Custom"] = {
	"filters": [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			on_change: function (query_report) {
				...
				if (based_on != "Project") {
					frappe.query_report.toggle_filter_display("project_type", true)
				} else {
					frappe.query_report.toggle_filter_display("project_type", false)
				}
			}
